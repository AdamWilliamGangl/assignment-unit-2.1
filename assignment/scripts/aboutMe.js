...
let luckyNumber = 2;
console.log('First lucky number is:', luckyNumber);
...
console.log('It is', adventurous, 'that I am adventurous!');
// 8 - Create a variable named `food`, and set its value to a string of your favorite food
let food = 'pizza';
console.log('First favorite food is:', food);
...
pets += 2
console.log('I acquired 2 new pets. My new total number of pets is', pets);
